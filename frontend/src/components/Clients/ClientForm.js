          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <label className={`flex items-start p-4 border-2 rounded-lg cursor-pointer transition-all ${formData.tipo_permanencia === 'con_permanencia'
                ...
                />
                <div className="flex-1">
                  <div className="font-semibold text-green-700">Con Permanencia</div>
                  <div className="text-xs text-gray-600 mt-1">
                    ✓ Compromiso mínimo de permanencia<br />
            ...
            {/* Selector de meses de permanencia */}
            {formData.tipo_permanencia === 'con_permanencia' && (
              <div className="mt-3 p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-xs text-green-600 mt-1">
                  El cliente se compromete a {formData.meses_permanencia || 6} mes(es) de permanencia
                </p>
              </div>
            )}
