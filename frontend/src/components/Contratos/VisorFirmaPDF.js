    ...
    const cargarContratoParaFirma = async () => {
        try {
            ...
            if (response.success && response.data) {
                ...
                const pdfUrl = await service.obtenerUrlPDF(contratoId);
                setPdfUrl(pdfUrl);
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-2 rounded-lg ${modoFirma === 'digital'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-2 rounded-lg ${modoFirma === 'imagen'
                                ? 'bg-blue-100 text-blue-700 border border-blue-300'
                                : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                }`}
                        >
