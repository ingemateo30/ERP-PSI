...
<body>
    ...
    <div class="page">
        ...
        <div class="two-columns">
            ...
            <div class="column">
                ...
                <div class="info-section">INFORMACIÓN DEL SUSCRIPTOR</div>
    ...
    ${this.generarPagina2(contratoData, empresaData, fechaHoy)}
    ${tienePermanencia ? this.generarPagina3Permanencia(contratoData, empresaData, fechaHoy, permanenciaMeses, valorTotal) : ''}
</body>
</html>`;
  }
  ...
  static generarPagina2(contratoData, empresaData, fechaHoy) {
    return `
    <!-- ============================================ -->
    <!-- PÁGINA 2 -->
    <!-- ============================================ -->
    <div class="page">
        ...
        <div class="two-columns">
            ...
            <div class="column">
                ...
                <div class="content-box">
                    ...
                    <div class="box-content">
                        ...
                        <br/><br/>
                        <span style="font-size: 7px;">Con esta firma acepta recibir la factura por medios electrónicos</span>
                    </div>
                </div>

                <!-- CÓMO COMUNICARSE CON NOSOTROS -->
                <div class="content-box">
                    <div class="box-title">CÓMO COMUNICARSE CON NOSOTROS<br/>(MEDIOS DE ATENCIÓN)</div>
                    <div class="box-content">
                        <div style="display: flex; align-items: center; margin-bottom: 3px;">
                            <div style="width: 20px; height: 20px; border: 1px solid #000; text-align: center; line-height: 18px; font-weight: bold; margin-right: 5px;">1</div>
                            <div>Nuestros medios de atención son: oficinas físicas, página web, redes sociales y líneas telefónicas gratuitas.</div>
                        </div>
                        <div style="display: flex; align-items: center; margin-bottom: 3px;">
                            <div style="width: 20px; height: 20px; border: 1px solid #000; text-align: center; line-height: 18px; font-weight: bold; margin-right: 5px;">2</div>
                        ...
                        <div style="display: flex; align-items: center; margin-bottom: 3px;">
                            <div style="width: 20px; height: 20px; border: 1px solid #000; text-align: center; line-height: 18px; font-weight: bold; margin-right: 5px;">3</div>
                        ...
                        <p style="font-weight: bold; text-align: center; margin: 6px 0;">Si no está de acuerdo con nuestra respuesta</p>
                        <div style="display: flex; align-items: center;">
                            <div style="width: 20px; height: 20px; border: 1px solid #000; text-align: center; line-height: 18px; font-weight: bold; margin-right: 5px;">4</div>
                            <div>Cuando su queja o petición sea por los servicios de internet, y esté relacionada con actos de negativa del contrato, suspensión del servicio, terminación del contrato, corte y facturación; usted puede insistir en su solicitud ante nosotros, dentro de los 10 días hábiles siguientes a la respuesta, y pedir que si no llegamos a una solución satisfactoria para usted, enviemos su reclamo directamente a la SIC (Superintendencia de Industria y comercio) quien resolverá de manera definitiva su solicitud. Esto se llama recurso de reposición y en subsidio apelación. Cuando su queja o petición sea por el servicio de televisión, puede enviar la misma a la Autoridad Nacional de Televisión, para que esta Entidad resuelva su solicitud.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                ...
                <!-- Otros términos -->
                <div class="box-content" style="font-size: 7.5px; margin-bottom: 6px;">
  ...
  static generarPagina3Permanencia(contratoData, empresaData, fechaHoy, meses, valorMensual) {
    return `
    <!-- ============================================ -->
  ...
  static async generarPDF(contratoData, empresaData, rutaSalida) {
    const html = this.generarHTML(contratoData, empresaData);
